"""
form https://github.com/lc82111/pytorch_morphological_dilation2d_erosion2d/blob/master/morphology.py
"""
import math
import pdb
import torch
...
class Morphology(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=5, soft_max=True, beta=15, type=None, device='cpu'):
        ...
        # set GPU, default one gpu to train
        ...
        self.weight = nn.Parameter(torch.Tensor(out_channels, in_channels, kernel_size, kernel_size).to(device),
                                   requires_grad=True)
